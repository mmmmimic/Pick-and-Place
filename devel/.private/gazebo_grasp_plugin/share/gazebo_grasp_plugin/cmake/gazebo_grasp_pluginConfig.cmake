...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_grasp_plugin_SOURCE_PREFIX /home/student/catkin_ws/src/gazebo-pkgs/gazebo_grasp_plugin)
  set(gazebo_grasp_plugin_DEVEL_PREFIX /home/student/catkin_ws/devel/.private/gazebo_grasp_plugin)
...
if(NOT "/home/student/catkin_ws/src/gazebo-pkgs/gazebo_grasp_plugin/include " STREQUAL " ")
  set(gazebo_grasp_plugin_INCLUDE_DIRS "")
  set(_include_dirs "/home/student/catkin_ws/src/gazebo-pkgs/gazebo_grasp_plugin/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_grasp_plugin' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/catkin_ws/src/gazebo-pkgs/gazebo_grasp_plugin/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/student/catkin_ws/devel/.private/gazebo_grasp_plugin/lib;/home/student/catkin_ws/devel/lib;/opt/ros/melodic/lib)
