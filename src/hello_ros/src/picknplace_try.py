...
##############################################
#Function for opening of a gripper
def open():
...
## setup the planner
  	...
  	arm_group.set_goal_joint_tolerance(0.01) #0.01
...
#	rospy.sleep(2)
	...
	#arm_group.go(wait=True)
#	arm_group.execute(plan1,wait=True) #change
	rospy.sleep(5)  # rest 5 seconds
##############################################################################################################
	# arm up
	print "========== ARM UP"
